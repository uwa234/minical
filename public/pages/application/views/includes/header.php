			...
			<div class="container">
			    ...
			    <div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						?>
								<li>
									<a href="<?php echo rtrim(getenv('PROJECT_URL') ?: 'https://demo.veurion.com/', '/'); ?>/online_reservation/select_dates_and_rooms/<?php echo $company_data['company_id']; ?>" class="nav-link text-right">
